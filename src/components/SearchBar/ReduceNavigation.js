...
const ReduceNavigation = ({
  ...
  return (
    <motion.div>
      <AppBar
        className={classes.rdNavigation}
        sx={{
          borderRadius: { xs: "0rem", sm: "10rem" },
          padding: { xs: "0.6rem", sm: "0rem" },
          width: { xs: "100vw", sm: "70vw", md: "46vw" },
          left: {
            xs: "0rem",
            sm: "calc(50% - 33vw)!important",
            md: "calc(50% - 23vw)!important",
          },
          top: { xs: "0rem", sm: "2.5rem" },
        }}
      >
        <Toolbar
          className={classes.newtoolbarstyle}
          sx={{
            flexDirection: { xs: "column", sm: "row" },
            padding: { xs: "0.3rem", sm: "0.1rem" },
          }}
        >
          <Button
            id="source-button"
          ...
          <BoltIcon
            ...
            sx={{
              margin: { xs: "0.5rem 1rem", sm: "0 1rem" },
          ...
          >
            {searchCoordinates && searchCoordinates.destination.label !== ""
              ...
              : "Destination"}
            {searchCoordinates &&
            searchCoordinates.destination.label.length > 26
              ? "..."
              : ""}
          </Button>
          <ArrowCircleLeftOutlinedIcon
            ...
            sx={{
              right: { xs: "0rem", sm: "-5rem" },
              top: { xs: "3.3rem", sm: "auto" },
              border: { xs: "2px solid black", sm: "3px solid black " },
